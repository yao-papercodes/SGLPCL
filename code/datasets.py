...
class HyperX(torch.utils.data.Dataset):
    ...
    def __getitem__(self, i):
        ...
        return i, data, label, x, y # data(patchsize * patchsize) label(a value)
...
class data_prefetcher():
    ...
    def preload(self):
        try:
            self.index, self.data, self.label, self.x, self.y = next(self.loader)
    ...
    def next(self):
        ...
        self.preload()
        return index.long(), data, label, x, y